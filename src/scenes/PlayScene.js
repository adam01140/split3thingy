class PlayScene extends Phaser.Scene {
    ...
    update() {
        ...
        if (this.spaceKeyReleased) {
            //alert("hi");
        }

        if (spacePressed && this.spaceKeyReleased) {
            // Play gunshot audio
            this.playerGunshot.play();
            this.spaceKeyReleased = false; // Set flag to false
        }

        // Reset space key released flag when space key is released
        if (!spacePressed) {
            this.spaceKeyReleased = true;
        }
